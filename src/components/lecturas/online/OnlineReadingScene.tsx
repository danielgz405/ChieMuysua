...
import styles from "./OnlineReadingScene.module.css";
...
export function OnlineReadingScene() {
  ...
  return (
    <div
      className="relative h-[370px] w-full [perspective:1500px] sm:h-[430px]"
      onPointerMove={handlePointerMove}
      onPointerLeave={handlePointerLeave}
      role="img"
      aria-label="Escena tridimensional de una lectura online: pregunta, carta y relación."
    >
      <div
      ...
      >
        ...
        {readingCards.map((card, index) => (
          <div
            key={card.index}
            className={`${styles.card} absolute left-1/2 top-1/2 h-[286px] w-[184px] border p-2 shadow-2xl shadow-black/25 sm:h-[340px] sm:w-[216px] sm:p-3 ${card.tone}`}
